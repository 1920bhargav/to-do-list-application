                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @endif
                            <span class="card-title" style="font-size: 25px;">User List</span>
                            <a href="{{route('user.create')}}" id="create-new-category" class="btn btn-sm btn-primary btn-theme waves-effect waves-light float-right">
...
@section('page_scripts')
    <script type="text/javascript">
        var ajax_url = "{{ route('user.index') }}";
        var delete_url = "{{route('admin.user.destroy')}}";
        var csrf_token = "{{csrf_token()}}";
        var change_status_url = "{{route('admin.user.change_status')}}"
    </script>
